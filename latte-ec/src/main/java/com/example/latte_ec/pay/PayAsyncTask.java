...
public class PayAsyncTask extends AsyncTask<String, Void, String> {
    ...
    private static final String AL_PAY_STATUS_SUCCESS = "9000";         //订单支付成功
    private static final String AL_PAY_STATUS_PAYING = "8000";          //订单处理中
    private static final String AL_PAY_STATUS_FAIL = "4000";            //订单支付失败
    private static final String AL_PAY_STATUS_CANCEL = "6001";          //用户取消
    private static final String AL_PAY_STATUS_CONNECT_ERROR = "6002";   //支付网络错误
