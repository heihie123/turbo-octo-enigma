...
public class RxRestClient {
    ...
    public RxRestClient(String url, Map<String, Object> params, RequestBody body, LoaderStyle loaderStyle,
    ...
    private Observable<String> request(HttpMethod method) {
        ...
        switch (method) {
            ...
            case UPLOAD:
                ...
                observable = RestCreator.getRxRestService().upload(URL, part);
                break;
            default:
                break;
        }
